...
class AppConstant {
  static String domainBaseUrl = 'YOUR_DOMAIN_BASE_URL';
  static String baseUrl= '$domainBaseUrl/api/';
  static String appName = 'Hyperlocal - Multivendor App';
  static String androidMapKey = 'YOUR_ANDROID_MAP_KEY';
  static String iosMapKey = 'YOUR_IOS_MAP_KEY';
  static String serverClientId = 'FIREBASE_SERVER_CLIENT_ID';
  ...
  static bool isDemo = SettingsData.instance.system?.demoMode ?? false;
  static String demoModeMessage = SettingsData().system?.customerDemoModeMessage ?? 'This is operation is allowed in Demo Mode.';
  static String demoModeLocationMessage = SettingsData().system?.customerLocationDemoModeMessage ?? 'Demo mode is enabled. Location will default automatically.';
