...
class AuthRepository {
  ...
  Future<String> googleLogin() async {
    ...
    try {
      ...
      // Convert error to string and check if it contains "cancel" (case-insensitive)
      final errorMessage = e.toString().toLowerCase();

      if (errorMessage.contains('cancel')) {
        // User cancelled the operation (e.g., login, payment, etc.)
        // You can either rethrow a specific exception, return null, or just log
        // Option 1: Rethrow a custom cancelled exception (recommended)
        return '';
        // Option 2: Just return without throwing (if function returns Future<String?>)
        // return null;

        // Option 3: Do nothing and swallow the error (not recommended for most cases)
        // return;
      } else {
