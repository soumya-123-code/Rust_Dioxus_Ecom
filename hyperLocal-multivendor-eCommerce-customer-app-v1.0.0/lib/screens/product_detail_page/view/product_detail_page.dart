                                ...
                                children: [
                                  ...
                                  ExpansionTile(
                                    ...
                                    children: [
                                      ...
                                      SpecificationRowWidget(
                                          label: l10n.packOf,
                                          value: product.quantityStepSize.toString()
                                      ),
                                      ...
                                      if(product.indicator.isNotEmpty)
                                        SpecificationRowWidget(
                                          ...
                                          value: removeUnderscores(capitalizeFirstLetter(product.indicator)),
                                        ),
                                      if(product.guaranteePeriod.isNotEmpty)
                                        SpecificationRowWidget(
                                          label: l10n.guaranteePeriod,
                                          value: product.guaranteePeriod.toString() == '0' ? l10n.na : product.guaranteePeriod,
                                        ),
                                      ...
                                      SpecificationRowWidget(
                                        ...
                                        value: product.isReturnable.toString() == '0' ? l10n.na : l10n.yes,
                                      ),
                                      Html(
                                          ...
                                          if (context.mounted) {
                                            context.read<CartBloc>().add(
                                              UpdateCartQty(
                                                  cartItem.cartKey,
                                                  cartItem.quantity + 1,
                                                  cartItem.serverCartItemId,context),
                                            );
                                          }
                                        },
                                        behavior: HitTestBehavior.opaque,
