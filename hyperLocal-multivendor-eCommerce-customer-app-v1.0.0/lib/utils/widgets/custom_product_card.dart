...
class CustomProductCard extends StatelessWidget {
      ...
      child: Stack(
        children: [
          ...
          Container(
            ...
            padding: boxFit == BoxFit.contain ? const EdgeInsets.all(10.0) : EdgeInsets.zero,
            child: ClipRRect(
              borderRadius: BorderRadius.circular(8.r),
              child: productImage.isNotEmpty
                  ? Hero(
                tag: 'product-image-$productId',
                  child: CustomImageContainer(imagePath: productImage, fit: boxFit),
              )
                ...
                return AnimatedButton(
                  ...
                  child: Container(
                    ...
                    child: Icon(
                      ...
                      color: finalIsWishListed ? AppTheme.primaryColor : isDarkMode(context) ? Colors.white54 : Colors.black26,
                      size: 15.r,
                    ),
                  ),
                );
  ...
  Widget productPriceWidget({
    ...
    return Row(
      children: [
        Text(
          '${AppConstant.currency}${formatPrice(double.parse(specialPrice), locale: locale)}',
          style: TextStyle(
        ...
        Expanded(
          child: Text(
            '${AppConstant.currency}${formatPrice(double.parse(productPrice), locale: locale)}',
            style: TextStyle(
