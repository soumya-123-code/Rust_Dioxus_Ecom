@extends('layouts.seller.app', ['page' => $menuSeller['notifications']['active'] ?? ""])
                ...
                <div class="card-table">
                    <div class="row w-full p-3">
                        <x-datatable id="notifications-table" :columns="$columns"
                                     route="{{ route('seller.notifications.datatable') }}"
        ...
        <div class="modal-dialog modal-sm modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-success" id="confirmMarkAllRead">{{ __('labels.yes_mark_all') }}</button>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="modal modal-blur fade" id="deleteNotificationModal" tabindex="-1" role="dialog" aria-hidden="true">
        <div class="modal-dialog modal-sm modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn" data-bs-dismiss="modal">{{ __('labels.cancel') }}</button>
                    <button type="button" class="btn btn-danger" id="confirmDeleteNotification">{{ __('labels.yes_delete') }}</button>
                </div>
            </div>
        </div>
    </div>
