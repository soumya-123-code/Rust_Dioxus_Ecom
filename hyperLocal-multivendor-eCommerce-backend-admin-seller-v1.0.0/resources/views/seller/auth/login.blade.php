...
@section('title', __('labels.seller_login'))
@section('content')
    <div>
                            ...
                            <div class="mb-2">
                                <label class="form-label">
                                    ...
                                    <span class="form-label-description"><a
                                            href="{{route('seller.password.request')}}">I forgot password</a></span>
                                </label>
                                    ...
                                    <div class="row g-3">
                                        <div class="col-126">
                                            <div class="border rounded p-3 h-100">
                                                <div class="d-flex justify-content-between align-items-center mb-2">
                                                    <strong>{{ __('labels.seller_credentials') }}</strong>
                                                    <button type="button"
                                                            class="btn btn-sm btn-outline-primary copy-cred"
                                                            data-target-form="#login-form"
                                                            data-email="{{ env('DEMO_SELLER_EMAIL', 'demoseller@gmail.com') }}"
                                                            data-password="{{ env('DEMO_PASSWORD', '12345678') }}">
                                                        {{ __('labels.copy_and_fill') }}
                                                    </button>
                                                </div>
                                                <div class="text-muted">{{ __('labels.email') }}: <code>{{ env('DEMO_SELLER_EMAIL', 'demoseller@gmail.com') }}</code></div>
                                                <div class="text-muted">{{ __('labels.password') }}: <code>{{ env('DEMO_PASSWORD', '12345678') }}</code></div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
