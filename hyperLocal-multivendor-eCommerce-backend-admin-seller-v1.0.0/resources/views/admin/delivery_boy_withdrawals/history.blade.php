@extends('layouts.admin.app', ['page' => $menuAdmin['delivery_boy_management']['active'] ?? "", 'sub_page' => $menuAdmin['delivery_boy_management']['route']['withdrawal_history']['sub_active']])
                        ...
                        <div class="card-body">
                            <div class="row w-full p-3">
                                <x-datatable id="withdrawal-history-table" :columns="$columns"
                                             route="{{ route('admin.delivery-boy-withdrawals.history.datatable') }}"
